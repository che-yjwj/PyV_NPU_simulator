...
def npu_test():
    core_type = 'single'
    program_name = 'NPU_TEST'
    path_to_bin = 'programs/npu_test/npu_test.bin'
    num_cycles = 50

    print("This test will trigger the NPU doorbell.")
    print("Check the output for logs from NPUControlMemory and Scheduler.")
    execute_bin(core_type, program_name, path_to_bin, num_cycles)
